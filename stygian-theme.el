...
;; Keywords: themes
;; URL: https://github.com/jimeh/stygian-theme.el
;;
...
(let ((brown-1 "#452E2E") (brown-2 "#865C38") (brown-3 "#4B3330")
      ...
      (dark-gray-1 "#444") (dark-gray-2 "#333"))
  (custom-theme-set-faces
   'stygian

   ;; Basics
   `(default ((t (:background ,black-3 :foreground ,white-1))))
   ...
   ;; Linum
   `(linum ((t (:background ,black-3 :foreground ,dark-gray-1))))
  ...
  (custom-theme-set-variables
   ...
   `(fci-rule-color ,dark-gray-2) ;; renders much brighter for some reason
   `(fci-rule-character-color ,dark-gray-2)
...
(provide-theme 'stygian)

;;; stygian-theme.el ends here
