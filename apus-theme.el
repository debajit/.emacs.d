;;; birds-of-paradise-plus-theme.el --- A brown/orange light-on-dark theme for Emacs 24 (deftheme).  -*- lexical-binding: t -*-
;;
...
(let ((brown-1 "#452E2E") (brown-2 "#865c38") (brown-3 "#4b3330")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-doc-face ((t (:foreground ,blue-1 :italic t))))
