...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(org-scheduled ((,class (:foreground ,brown-00))))
   ;; `(org-scheduled-today ((,class (:foreground ,func :weight bold :height 1.2))))
   `(org-scheduled-today ((,class (:weight bold :foreground ,brown-00))))
   ...
   `(magit-section-heading ((,class (:foreground ,blue-01 :background ,bg1 :weight bold :height 1.5 :inherit nil))))
   `(magit-section-highlight      ((,class (:background ,white-80))))
   `(magit-section-secondary-heading ((,class (:foreground ,red-10 :weight bold))))
   `(magit-header-line ((,class (:height 1.5))))
